...
class Patient(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['municipio'], name='idx_patient_municipio'),
            models.Index(fields=['posto_administrativo'], name='idx_patient_posto'),
            models.Index(fields=['suco'], name='idx_patient_suco'),
            models.Index(fields=['aldeia'], name='idx_patient_aldeia'),
